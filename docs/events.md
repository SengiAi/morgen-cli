[Skip to Content](https://docs.morgen.so/events#nextra-skip-nav)
...
- [List events](https://docs.morgen.so/events#list-events)
- [Event schema](https://docs.morgen.so/events#event-schema)
- [Differences with JSCalendar](https://docs.morgen.so/events#differences-with-jscalendar)
- [Additional fields](https://docs.morgen.so/events#additional-fields)
- [Google Calendar Color ID](https://docs.morgen.so/events#google-calendar-color-id)
- [Create an event](https://docs.morgen.so/events#create-an-event)
- [Request Body Fields](https://docs.morgen.so/events#request-body-fields)
- [Update an event](https://docs.morgen.so/events#update-an-event)
- [Request Body Fields](https://docs.morgen.so/events#request-body-fields-1)
- [Special cases](https://docs.morgen.so/events#special-cases)
- [Updating Alerts](https://docs.morgen.so/events#updating-alerts)
- [Updating Participants](https://docs.morgen.so/events#updating-participants)
- [Request the creation of a virtual meeting room](https://docs.morgen.so/events#request-the-creation-of-a-virtual-meeting-room)
- [Delete an event](https://docs.morgen.so/events#delete-an-event)
- [Common Validation Errors](https://docs.morgen.so/events#common-validation-errors)
- [Missing Required Timing Fields](https://docs.morgen.so/events#missing-required-timing-fields)
- [Invalid Timezone](https://docs.morgen.so/events#invalid-timezone)
- [Invalid Duration Format](https://docs.morgen.so/events#invalid-duration-format)
- [Event Identification Error](https://docs.morgen.so/events#event-identification-error)

[Question? Give us feedback](https://github.com/morgen-so/morgen-dev-docs/issues/new?title=Feedback%20for%20%E2%80%9CEvents%E2%80%9D&labels=feedback) [Edit this page](https://github.com/morgen-so/morgen-dev-docs/content/events.mdx) Scroll to top
...
## List events [Permalink for this section](https://docs.morgen.so/events\#list-events)
...
## Event schema [Permalink for this section](https://docs.morgen.so/events\#event-schema)
...
### Differences with JSCalendar [Permalink for this section](https://docs.morgen.so/events\#differences-with-jscalendar)

#### Additional fields [Permalink for this section](https://docs.morgen.so/events\#additional-fields)
...
#### Google Calendar Color ID [Permalink for this section](https://docs.morgen.so/events\#google-calendar-color-id)
...
## Create an event [Permalink for this section](https://docs.morgen.so/events\#create-an-event)
...
### Request Body Fields [Permalink for this section](https://docs.morgen.so/events\#request-body-fields)
...
## Update an event [Permalink for this section](https://docs.morgen.so/events\#update-an-event)
...
### Request Body Fields [Permalink for this section](https://docs.morgen.so/events\#request-body-fields-1)
...
### Special cases [Permalink for this section](https://docs.morgen.so/events\#special-cases)

#### Updating Alerts [Permalink for this section](https://docs.morgen.so/events\#updating-alerts)
...
#### Updating Participants [Permalink for this section](https://docs.morgen.so/events\#updating-participants)
...
## Request the creation of a virtual meeting room [Permalink for this section](https://docs.morgen.so/events\#request-the-creation-of-a-virtual-meeting-room)
...
## Delete an event [Permalink for this section](https://docs.morgen.so/events\#delete-an-event)
...
## Common Validation Errors [Permalink for this section](https://docs.morgen.so/events\#common-validation-errors)
...
### Missing Required Timing Fields [Permalink for this section](https://docs.morgen.so/events\#missing-required-timing-fields)
...
### Invalid Timezone [Permalink for this section](https://docs.morgen.so/events\#invalid-timezone)
...
### Invalid Duration Format [Permalink for this section](https://docs.morgen.so/events\#invalid-duration-format)
...
### Event Identification Error [Permalink for this section](https://docs.morgen.so/events\#event-identification-error)
...
[Calendars](https://docs.morgen.so/calendars "Calendars") [Tasks](https://docs.morgen.so/tasks "Tasks")
